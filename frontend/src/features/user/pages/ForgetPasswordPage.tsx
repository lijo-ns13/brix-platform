...
// Note: Since you mentioned zod is being used but it's not actually available
// in the React artifact environment, this code will show how to use it but
// won't be executable in the preview without modification
